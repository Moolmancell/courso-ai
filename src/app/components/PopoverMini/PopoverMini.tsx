...
export function PopoverMini() {
    return (
        <div className="p-3 border-1 border-zinc-300 rounded-3xl flex flex-col gap-2 bg-white">
            <Link href="/dashboard/settings" className="flex flex-row items-center gap-2 px-2 py-1">
                <Cog6ToothIcon className="size-4"/>
                <h1 className="text-base font-normal">Settings</h1>
            </Link>

            <Link href="/dashboard/logout" className="flex flex-row items-center gap-2 px-2 py-1">
